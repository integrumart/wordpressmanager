...
class WordPressSettingsDialog(gui.SettingsDialog):
	...
	def makeSettings(self, settingsSizer):
		...
		self.siteUrl = sHelper.addLabeledControl(_("Site &URL (e.g., https://example.com):"), wx.TextCtrl)
...
class CreateContentDialog(gui.SettingsDialog):
	...
	def fetchCategories(self):
		if requests is None:
			wx.CallAfter(ui.message, _("Requests library not available. Please check installation."))
			return
